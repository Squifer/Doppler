 ...
 * Modified by Kenneth Mallabo on 27/03/23.
 */
abstract public class QuizActivity extends AppCompatActivity {
    ...
    public void quizSelectCorrect(View view) {
        CharSequence text = "Correct Answer!";
        Toast toast = Toast.makeText(getApplicationContext(), text, duration);
        toast.show();
    }

    public void quizSelectWrong(View view) {
